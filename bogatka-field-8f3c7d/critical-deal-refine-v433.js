(function(){
  ...
  byKey.get('thirdPartyRights').help='Проверьте, свободно ли помещение сейчас, нет ли действующего договора аренды или субаренды, залога, ареста, судебного спора либо других ограничений. Попросите подтвердить ответ письменно.';
  byKey.get('landlordObligations').title='Зафиксируйте, что арендодатель должен сделать до передачи помещения (ремонт, электрика, устранение недостатков)';
