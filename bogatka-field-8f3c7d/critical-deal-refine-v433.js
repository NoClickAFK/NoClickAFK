(function(){
  ...
  byKey.get('investmentProtection').help='Попросите отправить проект договора на почту или в мессенджер. Проверьте срок аренды, условия продления, порядок повышения арендной платы и условия досрочного расторжения, а также порядок возврата депозита, если он предусмотрен, и порядок компенсации вложений в ремонт, если такие вложения планируются.';
