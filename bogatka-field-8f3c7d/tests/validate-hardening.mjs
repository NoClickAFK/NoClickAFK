...
const checks={
  ...
  'cloud-stability-v401.js':['background-sync-never-rebuilds-active-form','isInteracting','applyWithoutTouchingUi','restoreMutationsAfterSync','BogatkaCloudStability'],
...
if(!sw.includes("CACHE_NAME='bogatka-location-v404'"))errors.push('Service Worker cache version is not v404');
