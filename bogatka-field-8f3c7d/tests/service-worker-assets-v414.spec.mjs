...
test('versioned service worker asset list is unique and complete',()=>{
  ...
  for(const asset of ['./version-authority-v426.js','./report-live-v427.js','./workflow-v414.js','./workflow-v414.css','./location-panels-v419.js','./location-panels-render-v419.js','./location-panels-v419.css','./location-global-v421.js','./location-global-v421.css','./location-card-collapse-v422.js','./location-card-collapse-v422.css']){
