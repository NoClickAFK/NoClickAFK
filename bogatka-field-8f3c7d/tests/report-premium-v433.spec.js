...
test('repository fallback provenance points at the current functional runtime head',async({page})=>{
  ...
  expect(source).toContain("sourceCommit:'e07ebf93a19d3386f35f0c16df762a847ba27bfb'");
  expect(source).not.toContain("sourceCommit:'38dbe06bd24de8d5a895c431dd4683c3aae1b696'");
});