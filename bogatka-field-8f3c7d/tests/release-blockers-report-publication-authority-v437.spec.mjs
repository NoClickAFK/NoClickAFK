...
const APP='http://127.0.0.1:4173/bogatka-field-8f3c7d/?v=report-publication-authority-v437';
...
test('report publication follows the central mutation authority for every role state',async({page})=>{
