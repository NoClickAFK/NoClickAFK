...
for(const selector of ['.critical-deal-v430>summary::-webkit-details-marker','.economy-v400>summary::-webkit-details-marker','.launch-project-v400>summary::-webkit-details-marker','.critical-deal-v430>summary::marker','.economy-v400>summary::marker','.launch-project-v400>summary::marker'])assert.ok(css.includes(selector));
for(const selector of ['.critical-deal-v430>summary::before','.economy-v400>summary::before','.launch-project-v400>summary::before'])assert.ok(css.includes(selector));
assert.ok(css.includes('border-left:8px solid currentColor'));
